...
class ColoredWater:
    ...
    @staticmethod
    def get_first_non_zero(arr) -> int:
        try:
            return arr[arr != 0][0]
        except IndexError:
            return 0
...
if(__name__ == "__main__"):
    coloredwater = ColoredWater(np.array([[ 0,  1,  0,  5,  8,  9,  7,  4,  2,  8,  2,  5,  5, 10, 12],
                                          [ 0,  2,  0,  6,  3, 10,  9,  7, 11,  3, 11, 12,  3,  6, 13],
                                          [ 0,  3,  0,  7,  4,  2, 11, 11,  6, 12, 12, 13,  1, 13,  1],
                                          [ 0,  4,  0,  5,  9,  9,  7,  6,  8,  8, 13,  1,  4, 10, 10]]))
    
    # coloredwater = ColoredWater(np.array([[0,  0,  1,  3,  2,  4],
    #                                       [0,  0,  2,  4,  3,  3],
    #                                       [0,  0,  3,  2,  1,  2],
    #                                       [0,  0,  4,  1,  4,  1]]))

    for i in coloredwater.solve():
        print(i)